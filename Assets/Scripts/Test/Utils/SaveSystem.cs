...
public static class SaveSystem
{
    ...
    private static string _stageSection = "Stage";
    public static readonly string _stageKey = "LastCleared";
    ...
    public static bool CheckStageAble(int stage)
    {
        ...
        var value = IniFile.ReadFile(_settingFolderPath, _settingFilePath, _stageSection, _stageKey);
        if (int.TryParse(value, out var cleared))
        {
